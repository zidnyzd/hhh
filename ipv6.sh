...
TIMES="10"
CHATID="-4250078617"
KEY="7248854645:AAGcp6pgiALNdNiw-qavKVBxpL6hdlChK0Q"
...
clear
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " ZTR AUTOSCRIPT TUNNEL PREMIUM${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP "
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}storezid ${NC}${YELLOW}(${NC}${green}V1.0${NC}${YELLOW})${NC}"
echo -e " ›TEAM : ZidVPNstore ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/zidnyzd/AutoScript/main/"
...
function pasang_ssl() {
    ...
    systemctl stop nginx  # Pastikan tidak ada layanan yang menggunakan port 80
...
wget -q https://raw.githubusercontent.com/zidnyzd/AutoScript/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function ins_swab(){
clear
print_install "Installing Swap RAM 1 GB"
